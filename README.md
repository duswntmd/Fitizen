...
### [연주승](https://github.com/user-attachments/assets/dd9639d0-70a4-424b-8060-2ffe21b0725b)
- **도메인**: fitizen.store
- **프로젝트 총괄 및 점검**: 전체 프로젝트 관리, 병합, GitHub 관리
- **로그인 및 회원가입 (일반 유저)**
- **운동시설 리뷰**
- **게시판**: 게시판 및 하위 댓글 관리
- **시큐리티**: 애플리케이션 보안 관리
...
### [정재호](https://github.com/user-attachments/assets/9d092290-f91b-4f78-b680-9097546708f8)
- **로그인 (트레이너)**
- **마이페이지**: 사용자 개인 페이지 관리
...
### [박성재](https://github.com/user-attachments/assets/645d27c7-617c-4397-b527-f10bf110fb24)
- **회원 가입, 로그인, 아이디/비밀번호 찾기 CSS**: UI 디자인 및 스타일링
- **비밀번호 변경 메일 전송**
- **운동 추천 (일반, AI)**: 운동 추천 시스템 개발
